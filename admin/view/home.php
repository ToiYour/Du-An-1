                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h3 class="mb-3">
                                <span data-plugin="counterup"><?php echo number_format($thong_ke_home['total_price']) ?></span>
                                VNĐ
                            </h3>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h3 class="mb-3">
                                <span data-plugin="counterup"><?php echo number_format($thong_ke_home['avg_price']) ?></span>
                                VNĐ
                            </h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h3 class="mb-3" data-plugin="counterup">
                                <?php echo number_format($thong_ke_home['total_dh']) ?></h3>
                        </div>
                    </div>
                </div>
            </div>

                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Đồng hồ casio</td>
                                        <td>250.000.000đ</td>
                                        <td>Đồng hồ đa cấp</td>
                                        <td><img src="assets/images/media/sm-1.jpg" width="50px" height="50px" alt="">
                                        </td>
                                        <td>3</td>
                                        <td>Danh mục 1</td>
                                        <td>
                                            <a href="?act=list-detail" class="btn btn-light text-center p-2 " data-toggle="tooltip" data-placement="top" title="Xem chi tiết"><i class="bx bx-show font-weight-bold"></i></a>

                        ...
                        <form action="?act=delete-detail-sp" method="post">
                            <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php foreach ($detail_sp_all as $value) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="?act=update-detail-sp&id=<?php echo $value['id_chi_tiet_san_pham'] ?>" class="btn btn-light text-center p-2 " data-toggle="tooltip" data-placement="top" title="Sửa"><i class="bx bx-pencil font-weight-bold"></i></a>

...
function detail_san_pham_insert($gia_ban, $so_luong, $ngay_nhap, $id_san_pham, $id_size, $id_mau)
{
    $sql = "INSERT INTO chi_tiet_san_pham( gia_ban, so_luong,ngay_nhap, id_san_pham, id_size, id_mau) VALUES (?,?,?,?,?,?)";
    pdo_execute($sql,  $gia_ban, $so_luong, $ngay_nhap, $id_san_pham, $id_size, $id_mau);
}
...
function detail_san_pham_update($id_chi_tiet_san_pham,  $gia_ban, $so_luong, $id_san_pham, $id_size, $id_mau)
{
    $sql = "UPDATE chi_tiet_san_pham SET gia_ban=?,so_luong=?,id_san_pham=?,id_size=?,id_mau=? WHERE id_chi_tiet_san_pham = ?";
    pdo_execute($sql,  $gia_ban, $so_luong, $id_san_pham, $id_size, $id_mau, $id_chi_tiet_san_pham);
}

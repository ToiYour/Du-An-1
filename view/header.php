                        ...
                        <div class="col-lg-3">
                            <div class="right-blok-box text-white d-flex align-items-center">
                                ...
                                <div class="px-2 pb-2 position-relative user-account" style="cursor: pointer;">
                                    <img src="assets/images/avatar/<?php $login = user_select_by_id($_SESSION['login']['id_kh']); echo empty($login['hinh_anh']) ? 'no-avatar.jpg' : $login['hinh_anh'] ?>"
                                    ...
                                    <ul class="menu-user-hover ">
                                        <?php if ($_SESSION['login']['vai_tro'] == 1) : ?>

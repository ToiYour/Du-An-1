    ...
    <div class="container">
            ...
            <div class="col-12 text-center">
                <ul class="nav product-tab-menu" role="tablist">
                    <li class="product-tab-item nav-item active">
                        <a class="product-tab__link active" id="nav-featured-tab" data-bs-toggle="tab" href="#nav-featured" role="tab" aria-selected="true">Sản phẩm mới</a>
                    </li>

                    <li class="product-tab__item nav-item">
                        <a class="product-tab__link" id="nav-bestseller-tab" data-bs-toggle="tab" href="#nav-bestseller" role="tab" aria-selected="false">Sản phẩm bán chạy</a>
                    </li>
        ...
        <div class="tab-content product-tab__content" id="product-tabContent">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="single-product-area mt-30">
                                    <div class="product-thumb">
                                        <a href="?act=product-details&id=<?php echo  $value['id_san_pham'] ?>">
                                    ...
                                    <div class="product-caption">
                                        <h4 class="product-name">
                                            <a href="?act=product-details&id=<?php echo  $value['id_san_pham'] ?>"><?php echo  $value['ten_san_pham'] ?></a>
                                        </h4>
                                        <div class="price-box">
            ...
            <div class="tab-pane fade" id="nav-bestseller" role="tabpanel">
                <div class="product-carousel-group">
                    <div class="row product-active-row-4">
                        <?php foreach ($product_seller as $value) : ?>
                            <div class="col-lg-12">
                                <!-- single-product-area start -->
                                <div class="single-product-area mt-30">
                                    <div class="product-thumb">
            ...
            <div class="col-lg-4">
                <div class="singel-latest-blog">
                    <div class="aritcles-content">
                        ...
                        <h4>
                            <a href="blog-details.html" class="articles-name">Đánh giá Ruiz Watch và đồng hồ phổ biến
                                nhất
                                & đồng hồ
                                blog nghiêm túc
                            </a>
            ...
            <div class="col-lg-4">
                <div class="singel-latest-blog">
                    <div class="aritcles-content">
                        ...
                        <a href="blog-details.html" class="articles-name">Kết nối với thế giới: Giới thiệu
                            G-Sốc
                            MTG-B1000-1A</a>
                    </div>
                    <div class="articles-image">

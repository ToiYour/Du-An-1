                        ...
                        <div class="">
                            <div class="login-form-container">
                                <div class="login-register-form">
                                    <form action="?act=newPassword" method="post" id="myForms"
                                        onsubmit="return checkForms()">
                                        <div class="login-input-box">
                                            <label for="" class="form-label">Mã xác nhận</label>
                                            <div id="passwordHelpBlock" class="form-text text-danger errorMa"
                                                style="display: none;">
                                                Mã xác nhận bạn nhập không chính xác
                                            </div>
                                            <input class="form-control" type="text" name="maXacNhan"
                                                placeholder="Điền mã xác nhận" onkeyup="xacNhanMa()" autofocus>
                                            ...
                                            <div class="position-relative">
                                                <input type="password" disabled name="newPassword"
                                                    placeholder="Điền mật khẩu mới " class="mb-0 js-input-pass"
                                                    style="opacity: 0.2;">
                                                ...
                                                <div id="passwordHelpBlock "
                                                    class="form-text text-danger errorNewPassword">
                                        ...
                                        <div class="button-box my-3">
                                            ...
                                            <div class="button-box">
                                                <button class="login-btn btn" name="xacNhan" value="login"
